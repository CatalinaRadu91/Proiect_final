Feature: Zonia login feature
  ...
  # daca pun primul scenariul cu credentialele valide, restul nu mai trec... cum pot sa rezolv?
  # este din cauza ca la credentialele valide o data logat, nu se mai delogheaza?
