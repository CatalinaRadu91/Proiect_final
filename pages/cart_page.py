...
class CartPage(BasePage):
    TOTAL_PRICE = (By.XPATH, '//td[@class="price-per-unit-td"]/span[@class="price-int"]')
    ...
    def verify_total_price(self, expected_price):
        ...
        self.assertEqual(expected_price, actual, f"Price is incorrect, extracted price is {actual}")
